...
public class LoggerInterceptor implements Interceptor {
    ...
    private String tag;
    private boolean showRespose;

    public LoggerInterceptor(String logTag, boolean showResponse) {

        if (TextUtils.isEmpty(logTag)) {
            tag = TAG;
        }

        this.showRespose = showResponse;
        this.tag = logTag;
    }
